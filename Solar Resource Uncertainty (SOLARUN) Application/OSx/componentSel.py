...
def component(componentList):
    ...
    def scroll(event):
        canvas.configure(scrollregion=canvas.bbox("all"),width=360,height=460)
    ...
    root.wm_geometry('400x430+100+100')
    ...
    lab=tkinter.Label(root, text= 'Please uncheck the unwanted components: \n\nNote: If Zenith and Azimuth response are checked\n then uncheck directional response and vice versa.')
